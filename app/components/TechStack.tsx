...
const RADAR_NODES: RadarNode[] = [
  ...
  // OUTER ORBIT (R = 250px) - Tools, AI & Cloud Platforms
  {
    ...
    radius: 250,
    angleDeg: 0,
    note: "Advanced agentic coding environment, autonomous problem solving and AI pairing",
  ...
  },
  {
    ...
    radius: 250,
    angleDeg: 60,
    note: "Agentic AI development, prompt architecture and automated code generation",
  ...
  },
  {
    ...
    radius: 250,
    angleDeg: 120,
    note: "Atomic commits, branching strategies and rebase workflows",
  ...
  },
  {
    ...
    radius: 250,
    angleDeg: 180,
    note: "Containerized deployment environments, multi-stage images and Docker Compose orchestration",
  ...
  },
  {
    ...
    radius: 250,
    angleDeg: 240,
    note: "Continuous deployment pipelines, edge network routing and serverless functions",
  ...
  },
  {
    ...
    radius: 250,
    angleDeg: 300,
    note: "CSS3 animations, Flexbox/Grid layouts and responsive media queries",
